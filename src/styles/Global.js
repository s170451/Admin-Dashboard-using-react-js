const styles = {
  ...
  fullImg: "object-contain h-full w-full ",
  sectionImg: "w-100 h-100 minmd:w-11/12 minmd:h-11/12 object-contain h-96 w-full rounded-3xl",
  btnIcon: "w-8 h-8 minmd:w-10 minmd:h-10 object-contain",
